...
impl crate::GetTable for Irfmamount1 {
...
impl crate::GetTable for Apevent1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
...
/// * REGIONID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct MarketSuspendSchedule1 {
...
impl crate::GetTable for MarketSuspendSchedule1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "FORCE_MAJEURE".into(),
...
impl crate::GetTable for Apeventregion1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "AP".into(),
...
impl crate::GetTable for Overriderrp1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "FORCE_MAJEURE".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Regionapcintervals1 {
    /// Region Identifier
    pub regionid: String,
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
...
impl crate::GetTable for Regionapcintervals1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "AP".into(),
...
impl crate::GetTable for Irfmevents1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "FORCE_MAJEURE".into(),
...
impl crate::GetTable for Regionapc1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "AP".into(),
...
/// * SUSPENSION_ID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct MarketSuspendRegimeSum1 {
...
impl crate::GetTable for MarketSuspendRegimeSum1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "FORCE_MAJEURE".into(),
...
/// * EFFECTIVEDATE
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct MarketSuspendScheduleTrk1 {
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
    #[serde(with = "crate::mms_datetime_opt")]
...
impl crate::GetTable for MarketSuspendScheduleTrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "FORCE_MAJEURE".into(),
...
/// * SUSPENSION_ID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct MarketSuspendRegionSum1 {
    /// Unique identifier for this suspension event
    pub suspension_id: String,
...
impl crate::GetTable for MarketSuspendRegionSum1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "FORCE_MAJEURE".into(),
