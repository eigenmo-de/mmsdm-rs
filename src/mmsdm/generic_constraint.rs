...
impl crate::GetTable for Genconsetinvoke2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
...
impl crate::GetTable for Emsmaster1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "GENERIC_CONSTRAINT".into(),
