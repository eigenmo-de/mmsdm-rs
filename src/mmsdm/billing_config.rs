...
pub struct GstTransactionType1 {
...
impl crate::GetTable for GstTransactionType1 {
...
impl crate::GetTable for GstBasClass1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "BILLING_CONFIG".into(),
...
impl crate::GetTable for Billingcalendar2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "BILLING_CONFIG".into(),
...
/// * SECURITY_DEPOSIT_ID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct SecdepositProvision1 {
...
impl crate::GetTable for SecdepositProvision1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "BILLING_CONFIG".into(),
...
impl crate::GetTable for GstRate1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "BILLING_CONFIG".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct GstTransactionClass1 {
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
    /// The version number of the data set
    pub versionno: rust_decimal::Decimal,
...
impl crate::GetTable for GstTransactionClass1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "BILLING_CONFIG".into(),
...
/// * VERSION_DATETIME
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct SecdepositInterestRate1 {
...
impl crate::GetTable for SecdepositInterestRate1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "BILLING_CONFIG".into(),
