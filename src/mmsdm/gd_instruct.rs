...
impl crate::GetTable for Gdinstruct1 {
...
/// * INSTRUCTIONTYPEID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Instructionsubtype1 {
    /// Instruction type
...
impl crate::GetTable for Instructionsubtype1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "GD_INSTRUCT".into(),
...
impl crate::GetTable for Instructiontype1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "GD_INSTRUCT".into(),
