...
impl crate::GetTable for MnspPeroffer1 {
...
impl crate::GetTable for Biddayoffer2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "OFFER".into(),
...
impl crate::GetTable for Bidperoffer1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "OFFER".into(),
...
/// * PARTICIPANTID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct MtpasaOfferfiletrk1 {
    /// Unique participant identifier
    pub participantid: String,
    #[serde(with = "crate::mms_datetime")]
...
impl crate::GetTable for MtpasaOfferfiletrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "OFFER".into(),
...
impl crate::GetTable for BidperofferD2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
...
impl crate::GetTable for MnspFiletrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "BID".into(),
...
impl crate::GetTable for Bidofferfiletrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "OFFER".into(),
...
impl crate::GetTable for MnspOffertrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "OFFER".into(),
...
impl crate::GetTable for BiddayofferD2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "BID".into(),
...
impl crate::GetTable for MtpasaOfferdata1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "OFFER".into(),
...
impl crate::GetTable for MnspDayoffer2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "OFFER".into(),
