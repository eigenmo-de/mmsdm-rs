...
impl crate::GetTable for Realtimerating1 {
...
impl crate::GetTable for Equipmentdetail1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "NETWORK".into(),
...
impl crate::GetTable for Rating1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "NETWORK".into(),
...
impl crate::GetTable for Staticrating1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "NETWORK".into(),
...
impl crate::GetTable for Substationdetail1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "NETWORK".into(),
...
/// * OUTAGEID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Outageconstraintset1 {
...
impl crate::GetTable for Outageconstraintset1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "NETWORK".into(),
...
impl crate::GetTable for Outagedetail3 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "NETWORK".into(),
...
impl crate::GetTable for Outagestatuscode1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "NETWORK".into(),
