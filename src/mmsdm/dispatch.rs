...
impl crate::GetTable for Mnspbidtrk1 {
...
impl crate::GetTable for MrScheduleTrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for Regionsum4 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for Offertrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for Interconnectorres3 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
/// * SETTLEMENTDATE
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct IntermittentForecastTrk1 {
    #[serde(with = "crate::mms_datetime")]
    pub settlementdate: chrono::NaiveDateTime,
...
impl crate::GetTable for IntermittentForecastTrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for PriceRevision1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
...
/// * SETTLEMENTDATE
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct BlockedConstraints1 {
    #[serde(with = "crate::mms_datetime")]
    pub settlementdate: chrono::NaiveDateTime,
    /// Dispatch run no; always 1
    pub runno: rust_decimal::Decimal,
...
impl crate::GetTable for BlockedConstraints1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for Interconnection1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for Price4 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for UnitSolution2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for FcasReq2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for Constraint5 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for CaseSolution2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Constraintrelaxation1 {
    #[serde(with = "crate::mms_datetime")]
    pub settlementdate: chrono::NaiveDateTime,
    /// Dispatch run no
    pub runno: rust_decimal::Decimal,
...
impl crate::GetTable for Constraintrelaxation1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PRICELOAD".into(),
...
impl crate::GetTable for NegativeResidue1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for UnitScada1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for ConstraintFcasOcd1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PRICELOAD".into(),
...
impl crate::GetTable for LocalPrice1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
...
impl crate::GetTable for UnitConformance1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "DISPATCH".into(),
