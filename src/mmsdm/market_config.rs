...
impl crate::GetTable for Lossmodel1 {
...
impl crate::GetTable for Lossfactormodel1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
impl crate::GetTable for Intraregionalloc1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct MarketPriceThresholds1 {
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
...
impl crate::GetTable for MarketPriceThresholds1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Interconnectorconstraint1 {
    /// SPD Factor
...
impl crate::GetTable for Interconnectorconstraint1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
impl crate::GetTable for Region1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
impl crate::GetTable for Bidtypes1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Interconnectoralloc1 {
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
    /// Version No in respect to effective date
    pub versionno: rust_decimal::Decimal,
...
impl crate::GetTable for Interconnectoralloc1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Regionstandingdata1 {
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
...
impl crate::GetTable for Regionstandingdata1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Transmissionlossfactor2 {
...
impl crate::GetTable for Transmissionlossfactor2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
impl crate::GetTable for Bidtypestrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
...
impl crate::GetTable for Interconnector1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_CONFIG".into(),
