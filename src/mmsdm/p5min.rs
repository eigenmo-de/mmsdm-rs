...
impl crate::GetTable for Regionsolution5 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "P5MIN".into(),
...
/// * RUN_DATETIME
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Constraintsolution6 {
    #[serde(with = "crate::mms_datetime")]
    pub run_datetime: chrono::NaiveDateTime,
    #[serde(with = "crate::mms_datetime")]
    pub interval_datetime: chrono::NaiveDateTime,
...
impl crate::GetTable for Constraintsolution6 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "P5MIN".into(),
...
/// * RUN_DATETIME
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Interconnectorsoln4 {
    #[serde(with = "crate::mms_datetime")]
    pub run_datetime: chrono::NaiveDateTime,
...
impl crate::GetTable for Interconnectorsoln4 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "P5MIN".into(),
...
impl crate::GetTable for Unitsolution3 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "P5MIN".into(),
