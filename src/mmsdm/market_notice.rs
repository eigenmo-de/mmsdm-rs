...
impl crate::GetTable for Marketnoticedata1 {
...
impl crate::GetTable for Marketnoticetype1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_NOTICE".into(),
...
/// * PARTICIPANTID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Participantnoticetrk1 {
...
impl crate::GetTable for Participantnoticetrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "MARKET_NOTICE".into(),
