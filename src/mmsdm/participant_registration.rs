...
impl crate::GetTable for Participant1 {
...
/// * PARTICIPANTID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Participantcategoryalloc1 {
...
impl crate::GetTable for Participantcategoryalloc1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
/// * PARTICIPANTID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Participantcreditdetail1 {
...
impl crate::GetTable for Participantcreditdetail1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Participantclass1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Dudetailsummary4 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Stationownertrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct MnspInterconnector2 {
...
impl crate::GetTable for MnspInterconnector2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Genunits2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
/// * PARTICIPANTCATEGORYID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Participantcategory1 {
...
impl crate::GetTable for Participantcategory1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Bidduiddetails1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Dualloc1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Dudetail3 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Stadualloc1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Station1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Genmeter1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Stationoperatingstatus1 {
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
...
impl crate::GetTable for Stationoperatingstatus1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Bidduiddetailstrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Dispatchableunit1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
/// * PARTICIPANTID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Participantaccount1 {
    /// Name of the account
...
impl crate::GetTable for Participantaccount1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for GenunitsUnit1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for MnspParticipant1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
...
impl crate::GetTable for Stationowner1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PARTICIPANT_REGISTRATION".into(),
