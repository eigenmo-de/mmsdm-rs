...
/// * INTERCONNECTORID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct InterconnectorSoln3 {
    #[serde(with = "crate::trading_period")]
    pub predispatchseqno: crate::TradingPeriod,
    /// SPD Predispatch run no, typically 1. It increments if the case is re-run.
    pub runno: Option<rust_decimal::Decimal>,
...
impl crate::GetTable for InterconnectorSoln3 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
...
impl crate::GetTable for InterconnectrSens1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
...
/// * REGIONID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Pricesensitivities1 {
    #[serde(with = "crate::trading_period")]
    pub predispatchseqno: crate::TradingPeriod,
    /// LP Solver Predispatch run no, typically 1. It increments if the case is re-run.
    pub runno: Option<rust_decimal::Decimal>,
...
impl crate::GetTable for Pricesensitivities1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
...
/// * REGIONID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Regionfcasrequirement2 {
...
impl crate::GetTable for Regionfcasrequirement2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
...
impl crate::GetTable for ScenarioDemand1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
...
impl crate::GetTable for RegionPrices1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
...
impl crate::GetTable for RegionSolution4 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
...
impl crate::GetTable for ScenarioDemandTrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
...
impl crate::GetTable for CaseSolution1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
...
/// * DATETIME
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct ConstraintSolution5 {
    #[serde(with = "crate::trading_period")]
    pub predispatchseqno: crate::TradingPeriod,
    /// SPD Predispatch run no, typically 1. It increments if the case is re-run.
    pub runno: Option<rust_decimal::Decimal>,
...
impl crate::GetTable for ConstraintSolution5 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "PREDISPATCH".into(),
