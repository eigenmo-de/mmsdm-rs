...
pub struct MarketFeeExclusion1 {
...
impl crate::GetTable for MarketFeeExclusion1 {
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct SetcfgParticipantMpftrk1 {
...
impl crate::GetTable for SetcfgParticipantMpftrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
impl crate::GetTable for MarketFeeCatExcl1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct ParticipantBandfeeAlloc1 {
    /// Unique participant identifier
    pub participantid: String,
    /// Identifier for Market Fee
    pub marketfeeid: String,
...
impl crate::GetTable for ParticipantBandfeeAlloc1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
impl crate::GetTable for Marketfee1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct MarketFeeExclusionTrk1 {
    /// Unique participant identifier
    pub participantid: String,
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
...
impl crate::GetTable for MarketFeeExclusionTrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
impl crate::GetTable for Marketfeetrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
/// * VERSION_DATETIME
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct MarketFeeCatExclTrk1 {
    /// The excluded market fee
    pub marketfeeid: String,
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
...
impl crate::GetTable for MarketFeeCatExclTrk1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
///  _Half-hour data comprising a single reallocation transaction._
///
...
/// * REALLOCATIONID
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Reallocationinterval1 {
...
impl crate::GetTable for Reallocationinterval1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct SetcfgParticipantMpf1 {
    /// Participant identifier
    pub participantid: String,
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
...
impl crate::GetTable for SetcfgParticipantMpf1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
impl crate::GetTable for Marketfeedata1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
/// * VERSIONNO
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct AncillaryRecoverySplit1 {
    #[serde(with = "crate::mms_datetime")]
    pub effectivedate: chrono::NaiveDateTime,
...
impl crate::GetTable for AncillaryRecoverySplit1 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETTLEMENT_CONFIG".into(),
...
impl crate::GetTable for Reallocation2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "SETCFG".into(),
