...
impl crate::GetTable for Casesolution3 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "STPASA".into(),
...
/// * RUNTYPE
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Constraintsolution2 {
    #[serde(with = "crate::mms_datetime")]
    pub run_datetime: chrono::NaiveDateTime,
    #[serde(with = "crate::mms_datetime")]
    pub interval_datetime: chrono::NaiveDateTime,
...
impl crate::GetTable for Constraintsolution2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "STPASA".into(),
...
/// * RUNTYPE
#[derive(Debug, Clone, PartialEq, Eq, serde::Deserialize, serde::Serialize)]
pub struct Interconnectorsoln2 {
    #[serde(with = "crate::mms_datetime")]
    pub run_datetime: chrono::NaiveDateTime,
    #[serde(with = "crate::mms_datetime")]
    pub interval_datetime: chrono::NaiveDateTime,
...
impl crate::GetTable for Interconnectorsoln2 {
    fn get_file_key() -> crate::FileKey {
        crate::FileKey {
            data_set_name: "STPASA".into(),
