...
impl crate::GetTable for OperationalDemandActual2 {
    type PrimaryKey = OperationalDemandActual2PrimaryKey;
    type Partition = ();
...
impl crate::CompareWithRow for OperationalDemandActual2 {
    type Row = OperationalDemandActual2;

    fn compare_with_row(&self, row: &Self::Row) -> bool {
        self.interval_datetime == row.interval_datetime && self.regionid == row.regionid
    }
}
impl crate::CompareWithPrimaryKey for OperationalDemandActual2 {
    type PrimaryKey = OperationalDemandActual2PrimaryKey;
...
pub struct OperationalDemandActual2PrimaryKey {
    pub interval_datetime: chrono::NaiveDateTime,
    pub regionid: String,
}
impl crate::CompareWithRow for OperationalDemandActual2PrimaryKey {
    type Row = OperationalDemandActual2;
...
impl crate::CompareWithPrimaryKey for OperationalDemandActual2PrimaryKey {
    type PrimaryKey = OperationalDemandActual2PrimaryKey;
...
impl crate::PrimaryKey for OperationalDemandActual2PrimaryKey {}
#[cfg(feature = "save_as_parquet")]
impl crate::ArrowSchema for OperationalDemandActual2 {
...
impl crate::ArrowSchema for OperationalDemandForecast1 {
    fn arrow_schema() -> arrow2::datatypes::Schema {
        arrow2::datatypes::Schema::new(vec![
            ...
            arrow2::datatypes::Field::new("load_date", arrow2::datatypes::DataType::Date32, true),
            arrow2::datatypes::Field::new(
    ...
    fn partition_to_record_batch(
        ...
        for (_, row) in partition {
            ...
            regionid_array.push(row.regionid);
            load_date_array.push(row.load_date.map(|val| {
                i32::try_from((val.date() - chrono::NaiveDate::from_ymd(1970, 1, 1)).num_days())
                    .unwrap()
            }));
...
impl crate::GetTable for DemandIntermittentClusterAvail1 {
    type PrimaryKey = DemandIntermittentClusterAvail1PrimaryKey;
    type Partition = ();
    ...
    fn primary_key(&self) -> DemandIntermittentClusterAvail1PrimaryKey {
...
impl crate::CompareWithRow for DemandIntermittentClusterAvail1 {
    type Row = DemandIntermittentClusterAvail1;
...
impl crate::CompareWithPrimaryKey for DemandIntermittentClusterAvail1 {
    type PrimaryKey = DemandIntermittentClusterAvail1PrimaryKey;
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord)]
pub struct DemandIntermittentClusterAvail1PrimaryKey {
    pub clusterid: String,
    pub duid: String,
    pub offerdatetime: chrono::NaiveDateTime,
    pub periodid: rust_decimal::Decimal,
...
impl crate::CompareWithRow for DemandIntermittentClusterAvail1PrimaryKey {
    type Row = DemandIntermittentClusterAvail1;
...
impl crate::CompareWithPrimaryKey for DemandIntermittentClusterAvail1PrimaryKey {
    type PrimaryKey = DemandIntermittentClusterAvail1PrimaryKey;
...
impl crate::PrimaryKey for DemandIntermittentClusterAvail1PrimaryKey {}
#[cfg(feature = "save_as_parquet")]
impl crate::ArrowSchema for DemandIntermittentClusterAvail1 {
    fn arrow_schema() -> arrow2::datatypes::Schema {
        arrow2::datatypes::Schema::new(vec![
            arrow2::datatypes::Field::new(
                "tradingdate",
...
impl crate::ArrowSchema for DemandIntermittentDsRun1 {
    ...
    fn partition_to_record_batch(
        ...
        for (_, row) in partition {
            ...
            participant_timestamp_array.push(row.participant_timestamp.map(|val| {
                i32::try_from((val.date() - chrono::NaiveDate::from_ymd(1970, 1, 1)).num_days())
                    .unwrap()
            }));
...
impl crate::ArrowSchema for ForecastIntermittentGen1 {
    ...
    fn partition_to_record_batch(
        ...
        for (_, row) in partition {
            ...
            duid_array.push(row.duid);
            start_interval_datetime_array.push(
                i32::try_from(
                    (row.start_interval_datetime.date() - chrono::NaiveDate::from_ymd(1970, 1, 1))
                        .num_days(),
                )
                .unwrap(),
            );
            end_interval_datetime_array.push(
                i32::try_from(
                    (row.end_interval_datetime.date() - chrono::NaiveDate::from_ymd(1970, 1, 1))
                        .num_days(),
                )
                .unwrap(),
            );
...
impl crate::GetTable for DemandMtpasaIntermittentAvail1 {
    type PrimaryKey = DemandMtpasaIntermittentAvail1PrimaryKey;
    type Partition = ();
    ...
    fn primary_key(&self) -> DemandMtpasaIntermittentAvail1PrimaryKey {
...
impl crate::CompareWithRow for DemandMtpasaIntermittentAvail1 {
    type Row = DemandMtpasaIntermittentAvail1;
...
impl crate::CompareWithPrimaryKey for DemandMtpasaIntermittentAvail1 {
    type PrimaryKey = DemandMtpasaIntermittentAvail1PrimaryKey;
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord)]
pub struct DemandMtpasaIntermittentAvail1PrimaryKey {
    pub clusterid: String,
    pub duid: String,
    pub offerdatetime: chrono::NaiveDateTime,
    pub tradingdate: chrono::NaiveDateTime,
}
impl crate::CompareWithRow for DemandMtpasaIntermittentAvail1PrimaryKey {
    type Row = DemandMtpasaIntermittentAvail1;
...
impl crate::CompareWithPrimaryKey for DemandMtpasaIntermittentAvail1PrimaryKey {
    type PrimaryKey = DemandMtpasaIntermittentAvail1PrimaryKey;
...
impl crate::PrimaryKey for DemandMtpasaIntermittentAvail1PrimaryKey {}
#[cfg(feature = "save_as_parquet")]
impl crate::ArrowSchema for DemandMtpasaIntermittentAvail1 {
    fn arrow_schema() -> arrow2::datatypes::Schema {
        arrow2::datatypes::Schema::new(vec![
            arrow2::datatypes::Field::new(
                "tradingdate",
