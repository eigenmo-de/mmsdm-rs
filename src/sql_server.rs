...
for file_key in self.data.keys() {
    ...
    match (
        ...
        file_key.version,
            ...
            ("BILLING",Some("MR_SHORTFALL"), version) if version <= 5_i32 => {
                #[cfg(feature = "billing_run")]
                {
            ...
            ("BILLING",Some("MR_PAYMENT"), version) if version <= 5_i32 => {
                #[cfg(feature = "billing_run")]
                {
            ...
            ("BILLING",Some("MR_SUMMARY"), version) if version <= 5_i32 => {
                #[cfg(feature = "billing_run")]
                {
            ...
            ("BILLING",Some("CPDATA"), version) if version <= 6_i32 => {
                #[cfg(feature = "billing_run")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBillingCpdata6 @P1, @P2").await?;
                }
                #[cfg(not(feature = "billing_run"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("BILLING",Some("MR_RECOVERY"), version) if version <= 5_i32 => {
                #[cfg(feature = "billing_run")]
                {
            ...
            ("BILLING",Some("SMELTERREDUCTION"), version) if version <= 5_i32 => {
                #[cfg(feature = "billing_run")]
                {
            ...
            ("BILLING",Some("RESERVETRADERRECOVERY"), version) if version <= 1_i32 => {
                #[cfg(feature = "billing_run")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBillingReservetraderrecovery1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "billing_run"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("BILLING",Some("RESERVETRADERPAYMENT"), version) if version <= 1_i32 => {
                #[cfg(feature = "billing_run")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBillingReservetraderpayment1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "billing_run"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("METERDATA",Some("TRK"), version) if version <= 1_i32 => {
                #[cfg(feature = "meter_data")]
                {
            ...
            ("PREDISPATCH",Some("REGION_SOLUTION"), version) if version <= 5_i32 => {
                #[cfg(feature = "pre_dispatch")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertPredispatchRegionSolution5 @P1, @P2").await?;
                }
                #[cfg(not(feature = "pre_dispatch"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("ANCILLIARY_SERVICES",Some("CONTRACTREACTIVEPOWER"), version) if version <= 4_i32 => {
                #[cfg(feature = "ancillary_services")]
                {
                    let d: Vec<data_model::AncilliaryServicesContractreactivepower4> = self.get_table()?;
            ...
            ("ANCILLIARY_SERVICES",Some("CONTRACTRESTARTUNITS"), version) if version <= 1_i32 => {
                #[cfg(feature = "ancillary_services")]
                {
                    let d: Vec<data_model::AncilliaryServicesContractrestartunits1> = self.get_table()?;
            ...
            ("ANCILLIARY_SERVICES",Some("CONTRACTLOADSHED"), version) if version <= 2_i32 => {
                #[cfg(feature = "ancillary_services")]
                {
                    let d: Vec<data_model::AncilliaryServicesContractloadshed2> = self.get_table()?;
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertAncilliaryServicesContractloadshed2 @P1, @P2").await?;
                }
                #[cfg(not(feature = "ancillary_services"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("ANCILLIARY_SERVICES",Some("CONTRACTRESTARTSERVICES"), version) if version <= 2_i32 => {
                #[cfg(feature = "ancillary_services")]
                {
                    let d: Vec<data_model::AncilliaryServicesContractrestartservices2> = self.get_table()?;
            ...
            ("ANCILLIARY_SERVICES",Some("CONTRACTAGC"), version) if version <= 1_i32 => {
                #[cfg(feature = "ancillary_services")]
                {
                    let d: Vec<data_model::AncilliaryServicesContractagc1> = self.get_table()?;
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertAncilliaryServicesContractagc1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "ancillary_services"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("PARTICIPANT_REGISTRATION",Some("DUDETAILSUMMARY"), version) if version <= 4_i32 => {
                #[cfg(feature = "participant_registration")]
                {
            ...
            ("P5MIN",Some("INTERSENSITIVITIES"), version) if version <= 1_i32 => {
                #[cfg(feature = "p5min")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertP5minIntersensitivities1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "p5min"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("P5MIN",Some("PRICESENSITIVITIES"), version) if version <= 1_i32 => {
                #[cfg(feature = "p5min")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertP5minPricesensitivities1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "p5min"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("P5MIN",Some("REGIONSOLUTION"), version) if version <= 6_i32 => {
                #[cfg(feature = "p5min")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertP5minRegionsolution6 @P1, @P2").await?;
                }
                #[cfg(not(feature = "p5min"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("P5MIN",Some("SCENARIODEMAND"), version) if version <= 1_i32 => {
                #[cfg(feature = "p5min")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertP5minScenariodemand1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "p5min"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("P5MIN",Some("SCENARIODEMANDTRK"), version) if version <= 1_i32 => {
                #[cfg(feature = "p5min")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertP5minScenariodemandtrk1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "p5min"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("PDPASA",Some("INTERCONNECTORSOLN"), version) if version <= 1_i32 => {
                #[cfg(feature = "pdpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertPdpasaInterconnectorsoln1 @P1, @P2").await?;
                }
            ...
            ("PDPASA",Some("REGIONSOLUTION"), version) if version <= 6_i32 => {
                #[cfg(feature = "pdpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertPdpasaRegionsolution6 @P1, @P2").await?;
                }
                #[cfg(not(feature = "pdpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("PDPASA",Some("CONSTRAINTSOLUTION"), version) if version <= 1_i32 => {
                #[cfg(feature = "pdpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertPdpasaConstraintsolution1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "pdpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("BID",Some("MNSP_PEROFFER"), version) if version <= 1_i32 => {
                #[cfg(feature = "bids")]
                {
                    let d: Vec<data_model::BidMnspPeroffer1> = self.get_table()?;
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBidMnspPeroffer1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "bids"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("BIDS",Some("MNSP_DAYOFFER"), version) if version <= 1_i32 => {
                #[cfg(feature = "bids")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBidsMnspDayoffer1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "bids"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("BIDS",Some("BIDDAYOFFER"), version) if version <= 1_i32 => {
                #[cfg(feature = "bids")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBidsBiddayoffer1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "bids"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("BID",Some("MNSP_FILETRK"), version) if version <= 1_i32 => {
                #[cfg(feature = "bids")]
                {
            ...
            ("BID",Some("MNSP_OFFERTRK"), version) if version <= 1_i32 => {
                #[cfg(feature = "bids")]
                {
                    let d: Vec<data_model::BidMnspOffertrk1> = self.get_table()?;
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBidMnspOffertrk1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "bids"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("BIDS",Some("MNSP_BIDOFFERPERIOD"), version) if version <= 1_i32 => {
                #[cfg(feature = "bids")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBidsMnspBidofferperiod1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "bids"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("BIDS",Some("BIDOFFERFILETRK"), version) if version <= 1_i32 => {
                #[cfg(feature = "bids")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBidsBidofferfiletrk1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "bids"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("BIDS",Some("BIDOFFERPERIOD"), version) if version <= 1_i32 => {
                #[cfg(feature = "bids")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertBidsBidofferperiod1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "bids"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("OFFER",Some("BIDPEROFFER"), version) if version <= 1_i32 => {
                #[cfg(feature = "bids")]
                {
            ...
            ("STPASA",Some("INTERCONNECTORSOLN"), version) if version <= 3_i32 => {
                #[cfg(feature = "stpasa_solution")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertStpasaInterconnectorsoln3 @P1, @P2").await?;
                }
                #[cfg(not(feature = "stpasa_solution"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("STPASA",Some("CONSTRAINTSOLUTION"), version) if version <= 3_i32 => {
                #[cfg(feature = "stpasa_solution")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertStpasaConstraintsolution3 @P1, @P2").await?;
                }
                #[cfg(not(feature = "stpasa_solution"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("STPASA",Some("REGIONSOLUTION"), version) if version <= 6_i32 => {
                #[cfg(feature = "stpasa_solution")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertStpasaRegionsolution6 @P1, @P2").await?;
                }
                #[cfg(not(feature = "stpasa_solution"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("DUIDAVAILABILITY"), version) if version <= 1_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaDuidavailability1 @P1, @P2").await?;
                }
            ...
            ("MTPASA",Some("CONSTRAINTSUMMARY"), version) if version <= 1_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaConstraintsummary1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("CASERESULT"), version) if version <= 1_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaCaseresult1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("REGIONAVAILABILITY"), version) if version <= 3_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaRegionavailability3 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("REGIONITERATION"), version) if version <= 1_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaRegioniteration1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("CONSTRAINTRESULT"), version) if version <= 1_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaConstraintresult1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("INTERCONNECTORRESULT"), version) if version <= 1_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaInterconnectorresult1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("REGIONRESULT"), version) if version <= 2_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaRegionresult2 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("LOLPRESULT"), version) if version <= 1_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaLolpresult1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("REGIONSUMMARY"), version) if version <= 1_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaRegionsummary1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("MTPASA",Some("REGIONAVAILTRK"), version) if version <= 1_i32 => {
                #[cfg(feature = "mtpasa")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertMtpasaRegionavailtrk1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "mtpasa"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("OPERATIONAL_DEMAND",Some("ACTUAL"), version) if version <= 2_i32 => {
                #[cfg(feature = "demand_forecasts")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertOperationalDemandActual2 @P1, @P2").await?;
                }
                #[cfg(not(feature = "demand_forecasts"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("DISPATCH",Some("REGIONSUM"), version) if version <= 5_i32 => {
                #[cfg(feature = "dispatch")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertDispatchRegionsum5 @P1, @P2").await?;
                }
            ...
            ("SETTLEMENTS",Some("VICENERGYFIGURES"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("FCASCOMP"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("AGCRECOVERY"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("VICBOUNDARYENERGY"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("DAYTRACK"), version) if version <= 6_i32 => {
                #[cfg(feature = "settlement_data")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertSettlementsDaytrack6 @P1, @P2").await?;
                }
                #[cfg(not(feature = "settlement_data"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("SETTLEMENTS",Some("AGCPAYMENT"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("INTERVENTIONRECOVERY"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("MR_RECOVERY"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("LUNLOADRECOVERY"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("CPDATA"), version) if version <= 6_i32 => {
                #[cfg(feature = "settlement_data")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertSettlementsCpdata6 @P1, @P2").await?;
                }
                #[cfg(not(feature = "settlement_data"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("SETTLEMENTS",Some("MR_PAYMENT"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("INTERVENTION"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("VICENERGYFLOW"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("LOCALAREATNI"), version) if version <= 1_i32 => {
                #[cfg(feature = "settlement_data")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertSettlementsLocalareatni1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "settlement_data"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("SETTLEMENTS",Some("MARKETFEES"), version) if version <= 6_i32 => {
                #[cfg(feature = "settlement_data")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertSettlementsMarketfees6 @P1, @P2").await?;
                }
                #[cfg(not(feature = "settlement_data"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("SETTLEMENTS",Some("LULOADRECOVERY"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("LOCALAREAENERGY"), version) if version <= 1_i32 => {
                #[cfg(feature = "settlement_data")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertSettlementsLocalareaenergy1 @P1, @P2").await?;
                }
                #[cfg(not(feature = "settlement_data"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("SETTLEMENTS",Some("IRFMRECOVERY"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("LUNLOADPAYMENT"), version) if version <= 5_i32 => {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("TRADING",Some("UNIT_SOLUTION"), version) if version <= 2_i32 => {
            ...
            ("TRADING",Some("AVERAGEPRICE30"), version) if version <= 1_i32 => {
                #[cfg(feature = "trading_data")]
                {
                    ...
                    self.batched_insert(client, file_key, &d, "exec mmsdm_proc.InsertTradingAverageprice301 @P1, @P2").await?;
                }
                #[cfg(not(feature = "trading_data"))]
                {
                    log::warn!("Unhandled file key {:?}", file_key);
            ...
            ("TRADING",Some("REGIONSUM"), version) if version <= 4_i32 => {
                #[cfg(feature = "trading_data")]
                {
            ...
            ("MR",Some("EVENT_SCHEDULE"), version) if version <= 1_i32 => {
                #[cfg(feature = "mrevent")]
                {
            ...
            ("MR",Some("EVENT"), version) if version <= 1_i32 => {
                #[cfg(feature = "mrevent")]
                {
            ...
            ("MR",Some("PEROFFER_STACK"), version) if version <= 1_i32 => {
                #[cfg(feature = "mrevent")]
                {
            ...
            ("MR",Some("DAYOFFER_STACK"), version) if version <= 1_i32 => {
                #[cfg(feature = "mrevent")]
                {
