...
for file_key in self.data.keys() {
    match (
        ...
        file_key.version,
            ...
            ("BIDS",Some("BIDOFFERPERIOD"),1_i32) =>  {
                #[cfg(feature = "bids")]
                {
            ...
            ("BIDS",Some("BIDOFFERFILETRK"),1_i32) =>  {
                #[cfg(feature = "bids")]
                {
            ...
            ("BIDS",Some("MNSP_BIDOFFERPERIOD"),1_i32) =>  {
                #[cfg(feature = "bids")]
                {
            ...
            ("STPASA",Some("CONSTRAINTSOLUTION"),3_i32) =>  {
            ...
            ("STPASA",Some("REGIONSOLUTION"),6_i32) =>  {
                #[cfg(feature = "stpasa_solution")]
                {
            ...
            ("STPASA",Some("INTERCONNECTORSOLN"),3_i32) =>  {
                #[cfg(feature = "stpasa_solution")]
                {
            ...
            ("PDPASA",Some("REGIONSOLUTION"),6_i32) =>  {
                #[cfg(feature = "pdpasa")]
                {
            ...
            ("TRADING",Some("AVERAGEPRICE30"),1_i32) =>  {
                #[cfg(feature = "trading_data")]
                {
            ...
            ("BILLING",Some("RESERVETRADERPAYMENT"),1_i32) =>  {
                #[cfg(feature = "billing_run")]
                {
            ...
            ("BILLING",Some("RESERVETRADERRECOVERY"),1_i32) =>  {
                #[cfg(feature = "billing_run")]
                {
            ...
            ("SETTLEMENTS",Some("LOCALAREATNI"),1_i32) =>  {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("DAYTRACK"),6_i32) =>  {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("LOCALAREAENERGY"),1_i32) =>  {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("SETTLEMENTS",Some("MARKETFEES"),6_i32) =>  {
                #[cfg(feature = "settlement_data")]
                {
            ...
            ("PREDISPATCH",Some("REGION_SOLUTION"),5_i32) =>  {
                #[cfg(feature = "pre_dispatch")]
                {
            ...
            ("OPERATIONAL_DEMAND",Some("ACTUAL"),2_i32) =>  {
            ...
            ("P5MIN",Some("REGIONSOLUTION"),6_i32) =>  {
                #[cfg(feature = "p5min")]
                {
