...
def get_row_partition_name(row: List[str]) -> str:
    ...
    mapping = {
        ...
        ("SETTLEMENTS","LULOADRECOVERY"): 4,
        ("SETTLEMENTS","LUNLOADPAYMENT"): 4,
        ("SETTLEMENTS","LUNLOADRECOVERY"): 4,
        ...
        ("SETTLEMENTS","VICBOUNDARYENERGY"): 4,
        ("SETTLEMENTS","VICENERGYFIGURES"): 4,
        ("SETTLEMENTS","VICENERGYFLOW"): 4,
