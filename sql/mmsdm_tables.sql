...
create table mmsdm.P5minRegionsolution5 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[run_datetime] datetime2 not null,
[interval_datetime] datetime2 not null,
[regionid] varchar(10) not null,
...
go
create clustered columnstore index cci_P5minRegionsolution5 on mmsdm.P5minRegionsolution5;
go
...
create table mmsdm.PredispatchRegionSolution4 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[predispatchseqno] varchar(20) null,
[runno] decimal(3,0) null,
[regionid] varchar(10) not null,
...
go
create clustered columnstore index cci_PredispatchRegionSolution4 on mmsdm.PredispatchRegionSolution4;
go
...
create table mmsdm.BillingCpdata5 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[contractyear] decimal(4,0) not null,
[weekno] decimal(3,0) not null,
[billrunno] decimal(3,0) not null,
...
go
create clustered columnstore index cci_BillingCpdata5 on mmsdm.BillingCpdata5;
go
...
create table mmsdm.BillingResTraderPayment1 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[contractyear] decimal(4,0) not null,
[weekno] decimal(3,0) not null,
[billrunno] decimal(3,0) not null,
...
go
create clustered columnstore index cci_BillingResTraderPayment1 on mmsdm.BillingResTraderPayment1;
go
...
create table mmsdm.BillingResTraderRecovery1 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[contractyear] decimal(4,0) not null,
[weekno] decimal(3,0) not null,
[billrunno] decimal(3,0) not null,
...
go
create clustered columnstore index cci_BillingResTraderRecovery1 on mmsdm.BillingResTraderRecovery1;
go
...
create table mmsdm.SettlementsDaytrack5 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[settlementdate] datetime2 not null,
[regionid] varchar(10) null,
...
go
create clustered columnstore index cci_SettlementsDaytrack5 on mmsdm.SettlementsDaytrack5;
go
...
create table mmsdm.SettlementsMarketfees5 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[settlementdate] datetime2 not null,
[runno] decimal(3,0) not null,
[participantid] varchar(10) not null,
...
go
create clustered columnstore index cci_SettlementsMarketfees5 on mmsdm.SettlementsMarketfees5;
go
...
create table mmsdm.SettlementsCpdata5 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[settlementdate] datetime2 not null,
[versionno] decimal(10,0) not null,
[periodid] decimal(10,0) not null,
...
go
create clustered columnstore index cci_SettlementsCpdata5 on mmsdm.SettlementsCpdata5;
go
...
create table mmsdm.PdpasaRegionsolution5 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[run_datetime] datetime2 not null,
[interval_datetime] datetime2 not null,
[regionid] varchar(10) not null,
...
go
create clustered columnstore index cci_PdpasaRegionsolution5 on mmsdm.PdpasaRegionsolution5;
go
...
create table mmsdm.StpasaConstraintsolution2 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[run_datetime] datetime2 not null,
[interval_datetime] datetime2 not null,
[constraintid] varchar(20) not null,
...
go
create clustered columnstore index cci_StpasaConstraintsolution2 on mmsdm.StpasaConstraintsolution2;
go
...
create table mmsdm.StpasaInterconnectorsoln2 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[run_datetime] datetime2 not null,
[interval_datetime] datetime2 not null,
[interconnectorid] varchar(10) not null,
...
go
create clustered columnstore index cci_StpasaInterconnectorsoln2 on mmsdm.StpasaInterconnectorsoln2;
go
                        
create table mmsdm.StpasaRegionsolution5 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[run_datetime] datetime2 not null,
[interval_datetime] datetime2 not null,
[regionid] varchar(10) not null,
...
go
create clustered columnstore index cci_StpasaRegionsolution5 on mmsdm.StpasaRegionsolution5;
go
...
go
create clustered columnstore index cci_OfferBiddayoffer2 on mmsdm.OfferBiddayoffer2;
go
...
create table mmsdm.OfferMnspOffertrk1 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[settlementdate] datetime2 not null,
[offerdate] datetime2 not null,
[versionno] decimal(3,0) not null,
...
go
create clustered columnstore index cci_OfferMnspOffertrk1 on mmsdm.OfferMnspOffertrk1;
go
...
go
create clustered columnstore index cci_BidBidperofferD2 on mmsdm.BidBidperofferD2;
go
                        
create table mmsdm.OfferMnspDayoffer2 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[settlementdate] datetime2 not null,
[offerdate] datetime2 not null,
[versionno] decimal(3,0) not null,
...
go
create clustered columnstore index cci_OfferMnspDayoffer2 on mmsdm.OfferMnspDayoffer2;
go
...
create table mmsdm.OfferBidofferfiletrk1 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[participantid] varchar(10) not null,
[offerdate] datetime2 not null,
...
go
create clustered columnstore index cci_OfferBidofferfiletrk1 on mmsdm.OfferBidofferfiletrk1;
go
...
go
create clustered columnstore index cci_BidBiddayofferD2 on mmsdm.BidBiddayofferD2;
go
...
create table mmsdm.OfferMnspPeroffer1 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[settlementdate] datetime2 not null,
[offerdate] datetime2 not null,
[versionno] decimal(3,0) not null,
...
go
create clustered columnstore index cci_OfferMnspPeroffer1 on mmsdm.OfferMnspPeroffer1;
go
...
create table mmsdm.OperationalDemandActual1 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[interval_datetime] datetime2 not null,
[regionid] varchar(20) not null,
...
go
create clustered columnstore index cci_OperationalDemandActual1 on mmsdm.OperationalDemandActual1;
go
...
create table mmsdm.DispatchRegionsum4 (
file_log_id bigint not null foreign key references mmsdm.FileLog(file_log_id) on delete cascade,
[settlementdate] datetime2 not null,
[runno] decimal(3,0) not null,
[regionid] varchar(10) not null,
...
go
create clustered columnstore index cci_DispatchRegionsum4 on mmsdm.DispatchRegionsum4;
go
