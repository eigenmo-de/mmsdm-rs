...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Asoffer' + '.' + 'Offerrestartdata' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Asoffer' + '.' + 'Offerastrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Asoffer' + '.' + 'Offerlsheddata' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Asoffer' + '.' + 'Offerrpowerdata' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Asoffer' + '.' + 'Offeragcdata' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Genconsettrk' + '.' + 'Null' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Geqdesc' + '.' + 'Null' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Spdrc' + '.' + 'Null' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Geqrhs' + '.' + 'Null' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Spdicc' + '.' + 'Null' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Spdcpc' + '.' + 'Null' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'GenericConstraint' + '.' + 'Genconsetinvoke' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Gcrhs' + '.' + 'Null' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Genconset' + '.' + 'Null' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'GenericConstraint' + '.' + 'Emsmaster' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Gencondata' + '.' + 'Null' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Lossfactormodel' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Transmissionlossfactor' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Lossmodel' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Interconnectorconstraint' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Interconnector' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Region' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'MarketPriceThresholds' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Bidtypes' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Bidtypestrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Regionstandingdata' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Intraregionalloc' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketConfig' + '.' + 'Interconnectoralloc' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'SecdepInterestPay' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'GstSummary' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'DailyEnergySummary' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'SecdepositApplication' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Daytrk' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Irnspsurplussum' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Aspayments' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Whitehole' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Regionexports' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Irfm' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'NmasTstRecvryRbf' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Financialadjustments' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'GstDetail' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'MrShortfall' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Iraucsurplus' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Interresidues' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Asrecovery' + '.v' + '7' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Regionimports' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'SecdepInterestRate' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Iraucsurplussum' + '.v' + '7' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'MrRecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Irpartsurplussum' + '.v' + '7' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Smelterreduction' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Intraresidues' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'MrSummary' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Irnspsurplus' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'BillingCo2ePublication' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Runtrk' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Gendata' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'NmasTstRecvryTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'DirectionReconciliatn' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'ApcCompensation' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'NmasTstPayments' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'MrPayment' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Fees' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Irpartsurplus' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'ResTraderPayment' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'BillingCo2ePublicationTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Prioradjustments' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'EftshortfallDetail' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Realloc' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Cpdata' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'ApcRecovery' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'Regionfigures' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'BillingDirectionReconOther' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'EftshortfallAmount' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'ReallocDetail' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'ResTraderRecovery' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Billing' + '.' + 'NmasTstRecovery' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'Valuationid' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'ResidueTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraOfferProduct' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraPrudentialRun' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraOfferProfile' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'ResidueContracts' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraPrudentialExposure' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'ResiduePublicData' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionConfig' + '.' + 'AuctionRevenueTrack' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraFinancialAucMargin' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionConfig' + '.' + 'Auction' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionBids' + '.' + 'PriceBid' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'ResidueBidTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'ResiduePriceFundsBid' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraFinancialAucReceipts' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraFinancialAucMardetail' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraFinancialAucpayDetail' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'ResidueConEstimatesTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionConfig' + '.' + 'AuctionRevenueEstimate' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraPrudentialCashSecurity' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionConfig' + '.' + 'AuctionCalendar' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'ResidueConFunds' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionConfig' + '.' + 'AuctionRpEstimate' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'ResidueConData' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraCashSecurity' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'Residuecontractpayments' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraFinancialAucpaySum' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraFinancialRuntrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionConfig' + '.' + 'AuctionTranche' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionBids' + '.' + 'FundsBid' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionConfig' + '.' + 'AuctionIcAllocations' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'IrauctionBids' + '.' + 'FileTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Irauction' + '.' + 'SraPrudentialCompPosition' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Bid' + '.' + 'BidperofferD' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Offer' + '.' + 'MnspDayoffer' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Offer' + '.' + 'Bidofferfiletrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Offer' + '.' + 'MtpasaOfferdata' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Bid' + '.' + 'BiddayofferD' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Offer' + '.' + 'MnspPeroffer' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Offer' + '.' + 'Bidperoffer' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Offer' + '.' + 'MtpasaOfferfiletrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Bid' + '.' + 'MnspFiletrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Offer' + '.' + 'MnspOffertrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Offer' + '.' + 'Biddayoffer' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Stpasa' + '.' + 'Casesolution' + '.v' + '3' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Stpasa' + '.' + 'Interconnectorsoln' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Stpasa' + '.' + 'Constraintsolution' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Stpasa' + '.' + 'Regionsolution' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Mtpasa' + '.' + 'Reservelimit' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ReserveData' + '.' + 'Reserve' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Mtpasa' + '.' + 'ReservelimitSet' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Mtpasa' + '.' + 'ReservelimitRegion' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketNotice' + '.' + 'Participantnoticetrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketNotice' + '.' + 'Marketnoticetype' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'MarketNotice' + '.' + 'Marketnoticedata' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Network' + '.' + 'Outagestatuscode' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Network' + '.' + 'Realtimerating' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Network' + '.' + 'Rating' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Network' + '.' + 'Equipmentdetail' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Network' + '.' + 'Outagedetail' + '.v' + '3' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Network' + '.' + 'Outageconstraintset' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Network' + '.' + 'Substationdetail' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Network' + '.' + 'Staticrating' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Ap' + '.' + 'Regionapc' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ForceMajeure' + '.' + 'Irfmevents' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ForceMajeure' + '.' + 'Overriderrp' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ForceMajeure' + '.' + 'MarketSuspendScheduleTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ForceMajeure' + '.' + 'Irfmamount' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Ap' + '.' + 'Regionapcintervals' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Ap' + '.' + 'Apevent' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ForceMajeure' + '.' + 'MarketSuspendSchedule' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ForceMajeure' + '.' + 'MarketSuspendRegionSum' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ForceMajeure' + '.' + 'MarketSuspendRegimeSum' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Ap' + '.' + 'Apeventregion' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'GdInstruct' + '.' + 'Gdinstruct' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'GdInstruct' + '.' + 'Instructiontype' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'GdInstruct' + '.' + 'Instructionsubtype' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Mcc' + '.' + 'Constraintsolution' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Mcc' + '.' + 'Casesolution' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Trading' + '.' + 'Regionsum' + '.v' + '4' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Trading' + '.' + 'UnitSolution' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Trading' + '.' + 'Price' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Trading' + '.' + 'Interconnectorres' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Pdpasa' + '.' + 'Regionsolution' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Pdpasa' + '.' + 'Casesolution' + '.v' + '3' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'P5min' + '.' + 'Casesolution' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'P5min' + '.' + 'Unitsolution' + '.v' + '3' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'P5min' + '.' + 'Constraintsolution' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'P5min' + '.' + 'Interconnectorsoln' + '.v' + '4' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'P5min' + '.' + 'LocalPrice' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'P5min' + '.' + 'Regionsolution' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'P5min' + '.' + 'BlockedConstraints' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'InterconnectrSens' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'BlockedConstraints' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'CaseSolution' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'RegionSolution' + '.v' + '4' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'UnitSolution' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'Offertrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'Pricesensitivities' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'Mnspbidtrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'RegionPrices' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'LocalPrice' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'ScenarioDemandTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'InterconnectorSoln' + '.v' + '3' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'Regionfcasrequirement' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'ConstraintSolution' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Predispatch' + '.' + 'ScenarioDemand' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Prudential' + '.' + 'CompanyPosition' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Prudential' + '.' + 'Runtrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Mr' + '.' + 'PerofferStack' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Mr' + '.' + 'DayofferStack' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Mr' + '.' + 'EventSchedule' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Mr' + '.' + 'Event' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'MarketFeeCatExclTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'Marketfeedata' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'SetcfgParticipantMpf' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'MarketFeeExclusion' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'Marketfeetrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'ParticipantBandfeeAlloc' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'SetcfgParticipantMpftrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'MarketFeeCatExcl' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Setcfg' + '.' + 'Reallocationinterval' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'Marketfee' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'AncillaryRecoverySplit' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Setcfg' + '.' + 'Reallocation' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'SettlementConfig' + '.' + 'MarketFeeExclusionTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Lunloadpayment' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Irnspsurplus' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Fcasregionrecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'SetFcasRegulationTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Cpdataregion' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Gendata' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Restartpayment' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Daytrack' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Rpowerrecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Irpartsurplus' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Cpdata' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'FcasPayment' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Iraucsurplus' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Lshedrecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'MrPayment' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Intervention' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Reallocations' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Irfmrecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'NmasRecovery' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Lunloadrecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Intraregionresidues' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'ApcCompensation' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Interventionrecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'RunParameter' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Marketfees' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Lshedpayment' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'AncillarySummary' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Agcrecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Irsurplus' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'ApcRecovery' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Gendataregion' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Vicenergyfigures' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Restartrecovery' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'MrRecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Rpowerpayment' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Luloadrecovery' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Fcascomp' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Vicenergyflow' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'FcasRecovery' + '.v' + '6' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'NmasRecoveryRbf' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Vicboundaryenergy' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Smallgendata' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Settlements' + '.' + 'Agcpayment' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'VoltageInstruction' + '.' + 'Instruction' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'VoltageInstruction' + '.' + 'Track' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Meterdata' + '.' + 'Interconnector' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Meterdata' + '.' + 'Trk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Meterdata' + '.' + 'AggregateReads' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Meterdata' + '.' + 'IndividualReads' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'Interconnectorres' + '.v' + '3' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Priceload' + '.' + 'PriceRevision' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Priceload' + '.' + 'ConstraintFcasOcd' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'Interconnection' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'BlockedConstraints' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'UnitConformance' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'LocalPrice' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'UnitSolution' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'Regionsum' + '.v' + '4' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'MrScheduleTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'Price' + '.v' + '4' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'Constraint' + '.v' + '5' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'CaseSolution' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'IntermittentForecastTrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'NegativeResidue' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Priceload' + '.' + 'Constraintrelaxation' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'FcasReq' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'UnitScada' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'Offertrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Dispatch' + '.' + 'Mnspbidtrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'BillingConfig' + '.' + 'SecdepositProvision' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'BillingConfig' + '.' + 'Billingcalendar' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'BillingConfig' + '.' + 'GstTransactionClass' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'BillingConfig' + '.' + 'SecdepositInterestRate' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'BillingConfig' + '.' + 'GstTransactionType' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'BillingConfig' + '.' + 'GstRate' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'BillingConfig' + '.' + 'GstBasClass' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Forecast' + '.' + 'IntermittentGenData' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'Period' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'IntermittentGenLimit' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'OperationalDemand' + '.' + 'Actual' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'OperationalDemand' + '.' + 'Forecast' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'IntermittentDsPred' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'IntermittentClusterAvail' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'Trk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Forecast' + '.' + 'IntermittentGen' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'MtpasaIntermittentLimit' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'IntermittentDsRun' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Rooftop' + '.' + 'Actual' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'IntermittentGenLimitDay' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Rooftop' + '.' + 'Forecast' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'MtpasaIntermittentAvail' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'Demand' + '.' + 'IntermittentClusterAvailDay' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Participantcategoryalloc' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'MnspInterconnector' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Participantaccount' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Stationowner' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Bidduiddetailstrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Dudetail' + '.v' + '3' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Bidduiddetails' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Station' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Genmeter' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Stationownertrk' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Participantclass' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'MnspParticipant' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Genunits' + '.v' + '2' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Participantcreditdetail' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'GenunitsUnit' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Dudetailsummary' + '.v' + '4' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Participantcategory' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Dispatchableunit' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Stationoperatingstatus' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Stadualloc' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Dualloc' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
...
if exists (
    ...
    begin
        declare @msg nvarchar(max) = 'table ' + 'ParticipantRegistration' + '.' + 'Participant' + '.v' + '1' + ' from file ' + @file_name + ' already exists in the database';
        throw 60000, @msg, 0
    end
else
    insert into FileLog(file_name, data_set, sub_type, version)
