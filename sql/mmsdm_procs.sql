...
go
create or alter procedure mmsdm_proc.InsertP5minRegionsolution5
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.P5minRegionsolution5(
file_log_id,
[run_datetime],
[interval_datetime],
[regionid],
...
go
create or alter procedure mmsdm_proc.InsertPredispatchRegionSolution4
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.PredispatchRegionSolution4(
file_log_id,
[predispatchseqno],
[runno],
[regionid],
...
go
create or alter procedure mmsdm_proc.InsertBillingCpdata5
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.BillingCpdata5(
file_log_id,
[contractyear],
[weekno],
[billrunno],
...
go
create or alter procedure mmsdm_proc.InsertBillingResTraderPayment1
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.BillingResTraderPayment1(
file_log_id,
[contractyear],
[weekno],
[billrunno],
...
go
create or alter procedure mmsdm_proc.InsertBillingResTraderRecovery1
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.BillingResTraderRecovery1(
file_log_id,
[contractyear],
[weekno],
[billrunno],
...
go
create or alter procedure mmsdm_proc.InsertSettlementsDaytrack5
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.SettlementsDaytrack5(
file_log_id,
[settlementdate],
[regionid],
[exanterunstatus],
...
go
create or alter procedure mmsdm_proc.InsertSettlementsMarketfees5
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.SettlementsMarketfees5(
file_log_id,
[settlementdate],
[runno],
[participantid],
...
go
create or alter procedure mmsdm_proc.InsertSettlementsCpdata5
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.SettlementsCpdata5(
file_log_id,
[settlementdate],
[versionno],
[periodid],
...
go
create or alter procedure mmsdm_proc.InsertPdpasaRegionsolution5
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.PdpasaRegionsolution5(
file_log_id,
[run_datetime],
[interval_datetime],
[regionid],
...
go
create or alter procedure mmsdm_proc.InsertStpasaConstraintsolution2
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.StpasaConstraintsolution2(
file_log_id,
[run_datetime],
[interval_datetime],
[constraintid],
...
go
create or alter procedure mmsdm_proc.InsertStpasaInterconnectorsoln2
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.StpasaInterconnectorsoln2(
file_log_id,
[run_datetime],
[interval_datetime],
[interconnectorid],
...
go
create or alter procedure mmsdm_proc.InsertStpasaRegionsolution5
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.StpasaRegionsolution5(
file_log_id,
[run_datetime],
[interval_datetime],
[regionid],
...
create or alter procedure mmsdm_proc.InsertOfferBiddayoffer2
    ...
    @data nvarchar(max)
as begin
insert into mmsdm.OfferBiddayoffer2(
file_log_id,
[duid],
[bidtype],
[settlementdate],
...
go
create or alter procedure mmsdm_proc.InsertOfferMnspOffertrk1
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.OfferMnspOffertrk1(
file_log_id,
[settlementdate],
[offerdate],
[versionno],
...
go
create or alter procedure mmsdm_proc.InsertBidBidperofferD2
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.BidBidperofferD2(
file_log_id,
[settlementdate],
[duid],
[bidtype],
...
go
create or alter procedure mmsdm_proc.InsertOfferMnspDayoffer2
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.OfferMnspDayoffer2(
file_log_id,
[settlementdate],
[offerdate],
[versionno],
...
go
create or alter procedure mmsdm_proc.InsertOfferBidofferfiletrk1
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.OfferBidofferfiletrk1(
file_log_id,
[participantid],
[offerdate],
[filename],
...
go
create or alter procedure mmsdm_proc.InsertBidBiddayofferD2
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.BidBiddayofferD2(
file_log_id,
[settlementdate],
[duid],
[bidtype],
...
go
create or alter procedure mmsdm_proc.InsertOfferMnspPeroffer1
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.OfferMnspPeroffer1(
file_log_id,
[settlementdate],
[offerdate],
[versionno],
...
go
create or alter procedure mmsdm_proc.InsertOperationalDemandActual1
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.OperationalDemandActual1(
file_log_id,
[interval_datetime],
[regionid],
[operational_demand],
...
go
create or alter procedure mmsdm_proc.InsertDispatchRegionsum4
    @file_log_id bigint,
    @data nvarchar(max)
as begin
insert into mmsdm.DispatchRegionsum4(
file_log_id,
[settlementdate],
[runno],
[regionid],
