...
impl mmsdm_core::ArrowSchema for DispatchConstraint5 {
    ...
    fn new_builder() -> Self::Builder {
        DispatchConstraint5Builder {
            ...
            runno_array: arrow::array::builder::Decimal128Builder::new()
                .with_data_type(arrow::datatypes::DataType::Decimal128(3, 0)),
            constraintid_array: arrow::array::builder::StringBuilder::new(),
            dispatchinterval_array: arrow::array::builder::TimestampSecondBuilder::new(),
            intervention_array: arrow::array::builder::Decimal128Builder::new()
                .with_data_type(arrow::datatypes::DataType::Decimal128(2, 0)),
            rhs_array: arrow::array::builder::Decimal128Builder::new()
                .with_data_type(arrow::datatypes::DataType::Decimal128(15, 5)),
    ...
    fn append_builder(builder: &mut Self::Builder, row: Self::Row<'_>) {
        ...
        builder
            ...
            .append_value(row.dispatchinterval.start().timestamp());
        builder
            .intervention_array
            .append_value({
                let mut val = row.intervention;
...
pub struct DispatchConstraint5Builder {
    ...
    runno_array: arrow::array::builder::Decimal128Builder,
    constraintid_array: arrow::array::builder::StringBuilder,
    dispatchinterval_array: arrow::array::builder::TimestampSecondBuilder,
    intervention_array: arrow::array::builder::Decimal128Builder,
    rhs_array: arrow::array::builder::Decimal128Builder,
...
pub struct DispatchUnitSolution4Mapping([usize; 65]);
/// # Summary
///
/// ## DISPATCHLOAD
...
/// * SETTLEMENTDATE
#[derive(Debug, PartialEq, Eq)]
pub struct DispatchUnitSolution4Row<'data> {
...
impl<'data> DispatchUnitSolution4Row<'data> {
...
impl mmsdm_core::GetTable for DispatchUnitSolution4 {
    ...
    const DEFAULT_FIELD_MAPPING: Self::FieldMapping = DispatchUnitSolution4Mapping([
        4,
        5,
        6,
        7,
    ...
    type Row<'row> = DispatchUnitSolution4Row<'row>;
    type FieldMapping = DispatchUnitSolution4Mapping;
    ...
    fn field_mapping_from_row<'a>(
        ...
        Ok(DispatchUnitSolution4Mapping(base_mapping))
    }
    fn partition_suffix_from_row<'a>(
        row: mmsdm_core::CsvRow<'a>,
    ) -> mmsdm_core::Result<Self::Partition> {
    ...
    fn primary_key(row: &Self::Row<'_>) -> DispatchUnitSolution4PrimaryKey {
    ...
    fn partition_name(row: &Self::Row<'_>) -> alloc::string::String {
        alloc::format!(
            "dispatch_unit_solution_v4_{}_{}", Self::partition_suffix(& row).year,
            Self::partition_suffix(& row).month.number_from_month()
        )
    }
    fn to_static<'a>(row: &Self::Row<'a>) -> Self::Row<'static> {
        DispatchUnitSolution4Row {
            settlementdate: row.settlementdate.clone(),
            runno: row.runno.clone(),
            duid: row.duid.clone(),
...
impl<'data> mmsdm_core::CompareWithRow for DispatchUnitSolution4Row<'data> {
    type Row<'other> = DispatchUnitSolution4Row<'other>;
    fn compare_with_row<'other>(&self, row: &Self::Row<'other>) -> bool {
        self.duid() == row.duid() && self.intervention == row.intervention
            && self.runno == row.runno && self.settlementdate == row.settlementdate
    }
}
impl<'data> mmsdm_core::CompareWithPrimaryKey for DispatchUnitSolution4Row<'data> {
    type PrimaryKey = DispatchUnitSolution4PrimaryKey;
    fn compare_with_key(&self, key: &Self::PrimaryKey) -> bool {
...
impl<'data> mmsdm_core::CompareWithRow for DispatchUnitSolution4PrimaryKey {
    type Row<'other> = DispatchUnitSolution4Row<'other>;
    fn compare_with_row<'other>(&self, row: &Self::Row<'other>) -> bool {
        self.duid == row.duid() && self.intervention == row.intervention
            && self.runno == row.runno && self.settlementdate == row.settlementdate
...
impl mmsdm_core::ArrowSchema for DispatchUnitSolution4 {
    type Builder = DispatchUnitSolution4Builder;
    fn schema() -> arrow::datatypes::Schema {
        arrow::datatypes::Schema::new(
            alloc::vec::Vec::from([
                arrow::datatypes::Field::new(
...
#[cfg(feature = "arrow")]
pub struct DispatchUnitSolution4Builder {
    settlementdate_array: arrow::array::builder::TimestampSecondBuilder,
    runno_array: arrow::array::builder::Decimal128Builder,
    duid_array: arrow::array::builder::StringBuilder,
...
pub struct DispatchRegionsum7Mapping([usize; 120]);
/// # Summary
///
/// ## DISPATCHREGIONSUM
...
/// * SETTLEMENTDATE
#[derive(Debug, PartialEq, Eq)]
pub struct DispatchRegionsum7Row<'data> {
    /// Market date and time starting at 04:05
    pub settlementdate: chrono::NaiveDateTime,
    /// Dispatch run no; always 1
    pub runno: rust_decimal::Decimal,
...
impl<'data> DispatchRegionsum7Row<'data> {
    pub fn regionid(&self) -> &str {
        core::ops::Index::index(self.backing_data.as_slice(), self.regionid.clone())
    }
}
impl mmsdm_core::GetTable for DispatchRegionsum7 {
    ...
    const DEFAULT_FIELD_MAPPING: Self::FieldMapping = DispatchRegionsum7Mapping([
        4,
        5,
        6,
        7,
    ...
    type Row<'row> = DispatchRegionsum7Row<'row>;
    type FieldMapping = DispatchRegionsum7Mapping;
    ...
    fn field_mapping_from_row<'a>(
        ...
        Ok(DispatchRegionsum7Mapping(base_mapping))
    }
    fn partition_suffix_from_row<'a>(
        row: mmsdm_core::CsvRow<'a>,
    ) -> mmsdm_core::Result<Self::Partition> {
    ...
    fn primary_key(row: &Self::Row<'_>) -> DispatchRegionsum7PrimaryKey {
    ...
    fn partition_name(row: &Self::Row<'_>) -> alloc::string::String {
        alloc::format!(
            "dispatch_regionsum_v7_{}_{}", Self::partition_suffix(& row).year,
            Self::partition_suffix(& row).month.number_from_month()
        )
    }
    fn to_static<'a>(row: &Self::Row<'a>) -> Self::Row<'static> {
        DispatchRegionsum7Row {
            settlementdate: row.settlementdate.clone(),
            runno: row.runno.clone(),
            regionid: row.regionid.clone(),
            dispatchinterval: row.dispatchinterval.clone(),
...
impl<'data> mmsdm_core::CompareWithRow for DispatchRegionsum7Row<'data> {
    type Row<'other> = DispatchRegionsum7Row<'other>;
    fn compare_with_row<'other>(&self, row: &Self::Row<'other>) -> bool {
        self.dispatchinterval == row.dispatchinterval
            && self.intervention == row.intervention && self.regionid() == row.regionid()
            && self.runno == row.runno && self.settlementdate == row.settlementdate
...
impl<'data> mmsdm_core::CompareWithPrimaryKey for DispatchRegionsum7Row<'data> {
    type PrimaryKey = DispatchRegionsum7PrimaryKey;
    fn compare_with_key(&self, key: &Self::PrimaryKey) -> bool {
        self.dispatchinterval == key.dispatchinterval
            && self.intervention == key.intervention && self.regionid() == key.regionid
...
impl<'data> mmsdm_core::CompareWithRow for DispatchRegionsum7PrimaryKey {
    type Row<'other> = DispatchRegionsum7Row<'other>;
    fn compare_with_row<'other>(&self, row: &Self::Row<'other>) -> bool {
        self.dispatchinterval == row.dispatchinterval
            && self.intervention == row.intervention && self.regionid == row.regionid()
...
impl mmsdm_core::ArrowSchema for DispatchRegionsum7 {
    type Builder = DispatchRegionsum7Builder;
    fn schema() -> arrow::datatypes::Schema {
        arrow::datatypes::Schema::new(
            alloc::vec::Vec::from([
                arrow::datatypes::Field::new(
...
#[cfg(feature = "arrow")]
pub struct DispatchRegionsum7Builder {
    settlementdate_array: arrow::array::builder::TimestampSecondBuilder,
    runno_array: arrow::array::builder::Decimal128Builder,
    regionid_array: arrow::array::builder::StringBuilder,
    dispatchinterval_array: arrow::array::builder::TimestampSecondBuilder,
...
impl mmsdm_core::ArrowSchema for DispatchMnspbidtrk1 {
    ...
    fn new_builder() -> Self::Builder {
        DispatchMnspbidtrk1Builder {
            ...
            offersettlementdate_array: arrow::array::builder::TimestampSecondBuilder::new(),
            offereffectivedate_array: arrow::array::builder::TimestampSecondBuilder::new(),
    ...
    fn append_builder(builder: &mut Self::Builder, row: Self::Row<'_>) {
        ...
        builder
            ...
            .append_option(row.offersettlementdate.map(|val| val.timestamp()));
        builder
            .offereffectivedate_array
            .append_option(row.offereffectivedate.map(|val| val.timestamp()));
        builder
...
pub struct DispatchMnspbidtrk1Builder {
    ...
    offersettlementdate_array: arrow::array::builder::TimestampSecondBuilder,
    offereffectivedate_array: arrow::array::builder::TimestampSecondBuilder,
...
impl mmsdm_core::ArrowSchema for DispatchMrScheduleTrk1 {
    ...
    fn new_builder() -> Self::Builder {
        DispatchMrScheduleTrk1Builder {
            settlementdate_array: arrow::array::builder::TimestampSecondBuilder::new(),
            regionid_array: arrow::array::builder::StringBuilder::new(),
            mr_date_array: arrow::array::builder::TimestampSecondBuilder::new(),
    ...
    fn append_builder(builder: &mut Self::Builder, row: Self::Row<'_>) {
        builder.settlementdate_array.append_value(row.settlementdate.timestamp());
        builder.regionid_array.append_value(row.regionid());
        builder.mr_date_array.append_option(row.mr_date.map(|val| val.timestamp()));
        builder
            .version_datetime_array
            .append_option(row.version_datetime.map(|val| val.timestamp()));
        builder
            .lastchanged_array
            .append_option(row.lastchanged.map(|val| val.timestamp()));
    }
...
pub struct DispatchMrScheduleTrk1Builder {
    settlementdate_array: arrow::array::builder::TimestampSecondBuilder,
    regionid_array: arrow::array::builder::StringBuilder,
    mr_date_array: arrow::array::builder::TimestampSecondBuilder,
...
impl mmsdm_core::ArrowSchema for DispatchIntermittentForecastTrk1 {
    ...
    fn append_builder(builder: &mut Self::Builder, row: Self::Row<'_>) {
        ...
        builder
            .offerdatetime_array
            .append_option(row.offerdatetime.map(|val| val.timestamp()));
    }
    fn finalize_builder(
        builder: &mut Self::Builder,
    ) -> mmsdm_core::Result<arrow::array::RecordBatch> {
...
impl mmsdm_core::ArrowSchema for DispatchNegativeResidue1 {
    ...
    fn new_builder() -> Self::Builder {
        DispatchNegativeResidue1Builder {
            settlementdate_array: arrow::array::builder::TimestampSecondBuilder::new(),
            nrm_datetime_array: arrow::array::builder::TimestampSecondBuilder::new(),
            ...
            event_activated_di_array: arrow::array::builder::TimestampSecondBuilder::new(),
            event_deactivated_di_array: arrow::array::builder::TimestampSecondBuilder::new(),
    ...
    fn append_builder(builder: &mut Self::Builder, row: Self::Row<'_>) {
        builder.settlementdate_array.append_value(row.settlementdate.timestamp());
        builder.nrm_datetime_array.append_value(row.nrm_datetime.timestamp());
        builder
        ...
        builder
            ...
            .append_option(row.event_activated_di.map(|val| val.timestamp()));
        builder
            .event_deactivated_di_array
            .append_option(row.event_deactivated_di.map(|val| val.timestamp()));
        builder
...
pub struct DispatchNegativeResidue1Builder {
    settlementdate_array: arrow::array::builder::TimestampSecondBuilder,
    nrm_datetime_array: arrow::array::builder::TimestampSecondBuilder,
    ...
    event_activated_di_array: arrow::array::builder::TimestampSecondBuilder,
    event_deactivated_di_array: arrow::array::builder::TimestampSecondBuilder,
