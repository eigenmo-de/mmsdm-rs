...
impl mmsdm_core::ArrowSchema for PrudentialCompanyPosition1 {
    fn arrow_schema() -> arrow2::datatypes::Schema {
        arrow2::datatypes::Schema::from(vec![
            ...
            arrow2::datatypes::Field::new("company_id", arrow2::datatypes::DataType::LargeUtf8, false),
            arrow2::datatypes::Field::new("mcl", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("credit_support", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("trading_limit", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("current_amount_balance", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("security_deposit_provision", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("security_deposit_offset", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("security_deposit_balance", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("expost_realloc_balance", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("default_balance", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("outstandings", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("trading_margin", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("typical_accrual", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("prudential_margin", arrow2::datatypes::DataType::Decimal(16,6), true),
            arrow2::datatypes::Field::new("early_payment_amount", arrow2::datatypes::DataType::Decimal(18,8), true),
            arrow2::datatypes::Field::new("percentage_outstandings", arrow2::datatypes::DataType::Decimal(18,8), true),
    ...
    fn partition_to_chunk(partition: impl Iterator<Item=Self>) -> mmsdm_core::Result<arrow2::chunk::Chunk<std::sync::Arc<dyn arrow2::array::Array>>> {
        ...
        vec![
                ...
                std::sync::Arc::new(arrow2::array::Utf8Array::<i64>::from_slice(company_id_array)) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(mcl_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(credit_support_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(trading_limit_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(current_amount_balance_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(security_deposit_provision_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(security_deposit_offset_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(security_deposit_balance_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(expost_realloc_balance_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(default_balance_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(outstandings_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(trading_margin_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(typical_accrual_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(prudential_margin_array).to(arrow2::datatypes::DataType::Decimal(16,6))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(early_payment_amount_array).to(arrow2::datatypes::DataType::Decimal(18,8))) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(percentage_outstandings_array).to(arrow2::datatypes::DataType::Decimal(18,8))) as std::sync::Arc<dyn arrow2::array::Array>,
...
where S: futures_util::AsyncRead + futures_util::AsyncWrite + Unpin + Send,
{
    match (
        ...
        (Some("COMPANY_POSITION"), version) if version <= 1_i32 => {
            ...
            mmsdm_core::sql_server::batched_insert(client, file_key, mms_file.header(), &d, "exec mmsdm_proc.InsertPrudentialCompanyPosition1 @P1, @P2", chunk_size).await?;
        }
        (Some("RUNTRK"), version) if version <= 1_i32 => {
            let d: Vec<PrudentialRuntrk1> = mms_file.get_table()?;
            mmsdm_core::sql_server::batched_insert(client, file_key, mms_file.header(), &d, "exec mmsdm_proc.InsertPrudentialRuntrk1 @P1, @P2", chunk_size).await?;
        }
        _ => {
