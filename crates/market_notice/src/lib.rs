...
impl mmsdm_core::ArrowSchema for MarketNoticeMarketnoticedata1 {
    fn arrow_schema() -> arrow2::datatypes::Schema {
        arrow2::datatypes::Schema::from(
            vec![
                arrow2::datatypes::Field::new("noticeid",
                ...
                None), true), arrow2::datatypes::Field::new("typeid",
                arrow2::datatypes::DataType::LargeUtf8, true),
                arrow2::datatypes::Field::new("noticetype",
                arrow2::datatypes::DataType::LargeUtf8, true),
                arrow2::datatypes::Field::new("lastchanged",
                arrow2::datatypes::DataType::Timestamp(arrow2::datatypes::TimeUnit::Second,
                None), true), arrow2::datatypes::Field::new("reason",
                arrow2::datatypes::DataType::LargeUtf8, true),
                arrow2::datatypes::Field::new("externalreference",
                arrow2::datatypes::DataType::LargeUtf8, true)
            ],
        )
    }
    ...
    > {
        ...
        arrow2::chunk::Chunk::try_new(
                vec![
                    std::sync::Arc::new(arrow2::array::PrimitiveArray::from_vec(noticeid_array)
                    ...
                    >::from(typeid_array)) as std::sync::Arc < dyn arrow2::array::Array
                    >, std::sync::Arc::new(arrow2::array::Utf8Array::< i64
                    >::from(noticetype_array)) as std::sync::Arc < dyn
                    arrow2::array::Array >,
                    ...
                    >, std::sync::Arc::new(arrow2::array::Utf8Array::< i64
                    >::from(externalreference_array)) as std::sync::Arc < dyn
                    arrow2::array::Array >,
                ],
            )
            .map_err(Into::into)
...
impl mmsdm_core::ArrowSchema for MarketNoticeMarketnoticetype1 {
    ...
    > {
        ...
        arrow2::chunk::Chunk::try_new(
                vec![
                    std::sync::Arc::new(arrow2::array::Utf8Array::< i64
                    >::from_slice(typeid_array)) as std::sync::Arc < dyn
                    arrow2::array::Array >,
                    std::sync::Arc::new(arrow2::array::Utf8Array::< i64
                    >::from(description_array)) as std::sync::Arc < dyn
                    arrow2::array::Array >,
                    std::sync::Arc::new(arrow2::array::Utf8Array::< i64
                    >::from(raisedby_array)) as std::sync::Arc < dyn arrow2::array::Array
                    >,
                    std::sync::Arc::new(arrow2::array::PrimitiveArray::from(lastchanged_array)
                    .to(arrow2::datatypes::DataType::Timestamp(arrow2::datatypes::TimeUnit::Second,
                    None))) as std::sync::Arc < dyn arrow2::array::Array >,
