...
impl mmsdm_core::CompareWithRow for TradingAverageprice301 {
    ...
    fn compare_with_row(&self, row: &Self::Row) -> bool {
        self.perioddate == row.perioddate
...
impl mmsdm_core::CompareWithPrimaryKey for TradingAverageprice301 {
    ...
    fn compare_with_key(&self, key: &Self::PrimaryKey) -> bool {
        self.perioddate == key.perioddate
...
impl mmsdm_core::ArrowSchema for TradingAverageprice301 {
    fn arrow_schema() -> arrow2::datatypes::Schema {
        arrow2::datatypes::Schema::from(vec![
            arrow2::datatypes::Field::new("perioddate", arrow2::datatypes::DataType::Timestamp(arrow2::datatypes::TimeUnit::Second, None), false),
            ...
            arrow2::datatypes::Field::new("price_confidence", arrow2::datatypes::DataType::LargeUtf8, true),
    ...
    fn partition_to_chunk(partition: impl Iterator<Item=Self>) -> mmsdm_core::Result<arrow2::chunk::Chunk<std::sync::Arc<dyn arrow2::array::Array>>> {
        ...
        vec![
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from_vec(perioddate_array).to(arrow2::datatypes::DataType::Timestamp(arrow2::datatypes::TimeUnit::Second, None))) as std::sync::Arc<dyn arrow2::array::Array>,
                ...
                std::sync::Arc::new(arrow2::array::Utf8Array::<i64>::from(price_confidence_array)) as std::sync::Arc<dyn arrow2::array::Array>,
...
impl mmsdm_core::GetTable for TradingInterconnectorres2 {
    ...
    fn partition_name(&self) -> String {
        format!("trading_interconnectorres_v2_{}_{}", chrono::Datelike::year(&self.settlementdate), chrono::Datelike::month(&self.settlementdate))
    }
}
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, serde::Serialize, Ord)]
...
impl mmsdm_core::GetTable for TradingPrice2 {
    ...
    fn partition_name(&self) -> String {
        format!("trading_price_v2_{}_{}", chrono::Datelike::year(&self.settlementdate), chrono::Datelike::month(&self.settlementdate))
    }
}
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, serde::Serialize, Ord)]
...
impl mmsdm_core::ArrowSchema for TradingPrice2 {
    fn arrow_schema() -> arrow2::datatypes::Schema {
        arrow2::datatypes::Schema::from(vec![
            ...
            arrow2::datatypes::Field::new("invalidflag", arrow2::datatypes::DataType::LargeUtf8, true),
            arrow2::datatypes::Field::new("lastchanged", arrow2::datatypes::DataType::Timestamp(arrow2::datatypes::TimeUnit::Second, None), true),
    ...
    fn partition_to_chunk(partition: impl Iterator<Item=Self>) -> mmsdm_core::Result<arrow2::chunk::Chunk<std::sync::Arc<dyn arrow2::array::Array>>> {
        ...
        vec![
                ...
                std::sync::Arc::new(arrow2::array::Utf8Array::<i64>::from(invalidflag_array)) as std::sync::Arc<dyn arrow2::array::Array>,
                std::sync::Arc::new(arrow2::array::PrimitiveArray::from(lastchanged_array).to(arrow2::datatypes::DataType::Timestamp(arrow2::datatypes::TimeUnit::Second, None))) as std::sync::Arc<dyn arrow2::array::Array>,
...
where S: futures_util::AsyncRead + futures_util::AsyncWrite + Unpin + Send,
{
    match (
        ...
        (Some("AVERAGEPRICE30"), version) if version <= 1_i32 => {
            ...
            mmsdm_core::sql_server::batched_insert(client, file_key, mms_file.header(), &d, "exec mmsdm_proc.InsertTradingAverageprice301 @P1, @P2", chunk_size).await?;
        }
        (Some("INTERCONNECTORRES"), version) if version <= 2_i32 => {
            let d: Vec<TradingInterconnectorres2> = mms_file.get_table()?;
            mmsdm_core::sql_server::batched_insert(client, file_key, mms_file.header(), &d, "exec mmsdm_proc.InsertTradingInterconnectorres2 @P1, @P2", chunk_size).await?;
        }
        (Some("PRICE"), version) if version <= 2_i32 => {
            let d: Vec<TradingPrice2> = mms_file.get_table()?;
            mmsdm_core::sql_server::batched_insert(client, file_key, mms_file.header(), &d, "exec mmsdm_proc.InsertTradingPrice2 @P1, @P2", chunk_size).await?;
        }
        _ => {
